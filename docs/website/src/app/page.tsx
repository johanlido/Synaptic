...
import { ArrowRightIcon, CheckIcon, RocketLaunchIcon, CpuChipIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <div className="inline-flex items-center px-4 py-2 bg-gray-900 border border-gray-700 rounded-full text-gray-300 text-sm mb-8">
              ...
              World&apos;s First AI Personality-Aware Development Orchestrator
            </div>
